...
export default function AtAGlance ({ colorText = 'Usa' , glanceData }) {
  return (
    <div className='section__spacing '>
      ...
      <div className='bg-[#FFF9F3] rounded-lg p-10 mt-10 '>
        <div className='grid grid-cols-6 border-b-[1px] border-black/10 pb-3 '>
        ...
        {glanceData.map(item => (
          <div
            key={item.id}
            className='grid grid-cols-6  items-center border-b-[1px] border-black/10 pb-5 py-3'
          >
